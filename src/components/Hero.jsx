  ...
  return (
    <>
      <section className="bg-white dark:bg-gray-900 w-auto m-auto pt-1">
        <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-7 lg:grid-cols-12">
          <div className="lg:ml-[10%] mr-auto place-self-center lg:col-span-7">
