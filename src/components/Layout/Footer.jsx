        ...
        <footer className=" mt-5 bg-white dark:bg-gray-900 shadow-md">
            <div className="container px-6 py-8 mx-auto">
                ...
                <div className="flex flex-col items-center sm:flex-row sm:justify-between">
                    <p className="text-sm text-gray-500 dark:text-gray-300">resumate-resume.netlify.app © Copyright 2024. All Rights Reserved.</p>
                    ...
                    <div className="flex -mx-2">
                        ...
                        <Link to="https://github.com/tilerahul" target="_blank" className="mx-2 text-gray-600 transition-colors duration-300 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-400" aria-label="Github">
                            <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
